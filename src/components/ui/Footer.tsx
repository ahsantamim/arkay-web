...
const Footer = () => {
  return (
    <section className="py-10 bg-black w-screen sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p className=" leading-relaxed text-sm text-white mt-7">
          ...
          <div>
            <p className="text-sm tracking-widest text-white uppercase">Help</p>
            ...
            <form action="#" method="POST" className="mt-6">
              <div>
                ...
                <input
                  ...
                  className="block w-full p-4 text-white placeholder-gray-400 transition-all duration-200 bg-gray-900 border border-gray-700  focus:outline-none focus:border-blue-600 caret-blue-600"
                />
              </div>

              <button
                type="submit"
                className="inline-flex items-center justify-center px-6 py-4 mt-3  text-white transition-all duration-200 bg-blue-600  hover:bg-blue-700 focus:bg-blue-700"
              >
                Subscribe
              </button>
            </form>
